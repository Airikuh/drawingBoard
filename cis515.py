...
print("Imported cis515, version " + __version__)
pygame.init()
...
# A QWidget that contains a QImage object and a QPainter object to work on the image
...
# End of class CS1Canvas(QWidget):
...
def start_graphics(draw_func=noop, frames=1, data=None, framerate=40,
                title="cis515/451", width=400, height=400,
                mouse_press=noop, mouse_release = noop, mouse_move=noop,
                key_press=noop, key_release=noop):


#def start_graphics(draw_func=noop, data=None, width=400, height=400,title="cis515/451", framerate=40,
                #mouse_press=noop, mouse_release = noop, mouse_move=noop,
                #key_press=noop, key_release=noop):
